...
var AppApi = function (__exports) {
    ...
    var createApp = __exports.createApp = function (state, view, update, createRenderer) {
        return new Types.AppSpecification(state, view, update, function (_arg1) {}, createRenderer, "body", new List$1(), new List$1());
    };
    ...
    var startAndExposeMessageSink = __exports.startAndExposeMessageSink = function (appSpec) {
        var createInitApp = function createInitApp(post) {
            ...
            return new Types.App(appSpec.InitState, new List$1(), render, appSpec.Subscribers);
        };
...
var Location = function () {
    function Location(href, host, hostname, protocol, origin, port, pathname, search, hash$$1) {
        _classCallCheck$1(this, Location);
...
var NavigationAction = function () {
    function NavigationAction(caseName, fields) {
        _classCallCheck$1(this, NavigationAction);

        this.Case = caseName;
        this.Fields = fields;
    }

    _createClass$1(NavigationAction, [{
        key: _Symbol.reflection,
        value: function () {
            return {
...
function withNavigation(parser, urlUpdate, app) {
    var update_ = function update_(model) {
        return function (_arg1) {
            if (_arg1.Case === "Message") {
                return function (tupledArg) {
                    return [tupledArg[0], map$$1(function () {
                ...
                }(app.Update(model)(_arg1.Fields[0]));
            } else {
                return function (tupledArg) {
                    return [tupledArg[0], map$$1(function () {
                        var mapping = function mapping(arg0) {
    ...
    var popStateProducer = function popStateProducer(h$$1) {
        var popstateHandler = function popstateHandler(_arg2) {
            var location = Location.getLocation();
            h$$1(new Types.AppMessage("Message", [new NavigationAction("Change", [location])]));
            return null;
        };
    ...
    var producers = function () {
        var mappedProducers = map$$1(function () {
            var map$$1 = function () {
                var map$$1 = function map$$1(arg0) {
                    return new NavigationAction("Message", [arg0]);
                };

                return function (_arg1) {
                    return AppApi.mapAppMessage(map$$1, _arg1);
                };
            }();

            return function (p) {
                return AppApi.mapProducer(map$$1, p);
            };
        }(), app.Producers);
        return new List$1(popStateProducer, mappedProducers);
    }();

    var subscribers = map$$1(function () {
...
var Tags = function (__exports) {
    var elem = __exports.elem = function (tagName, attrs, children) {
        return new Types$1.DomNode("Element", [[tagName, attrs], children]);
    };

    var voidElem = __exports.voidElem = function (tagName, attrs) {
        return new Types$1.DomNode("VoidElement", [[tagName, attrs]]);
    };

    var whiteSpace = __exports.whiteSpace = function (x) {
        return new Types$1.DomNode("WhiteSpace", [x]);
    };

    var text = __exports.text = function (x) {
        return new Types$1.DomNode("Text", [x]);
    };
...
var Attributes = function (__exports) {
    var attribute = __exports.attribute = function (key, value) {
        return new Types$1.Attribute("Attribute", [[key, value]]);
    };

    var property = __exports.property = function (key, value) {
        return new Types$1.Attribute("Property", [[key, value]]);
    };
...
var Events = function (__exports) {
    var onMouseEvent = __exports.onMouseEvent = function (eventType, f) {
        ...
        return new Types$1.Attribute("EventHandler", [[eventType, h$$1]]);
    };
    ...
    var onKeyboardEvent = __exports.onKeyboardEvent = function (eventType, f) {
        return new Types$1.Attribute("EventHandler", [[eventType, f]]);
    };
...
var Svg = function (__exports) {
    var svgNS = __exports.svgNS = function () {
        return new Types$1.Attribute("Property", [["namespace", "http://www.w3.org/2000/svg"]]);
    };

    var svgElem = __exports.svgElem = function (tagName, attrs, children) {
        return new Types$1.DomNode("Element", [[tagName, new List$1(svgNS(), attrs)], children]);
    };
...
function urlParser(location) {
  return _Number$parseInt(location.Hash.substr(2));
}
var Model = function () {
...
var initValue = urlParser(Location.getLocation());
...
function update(model, action) {
  return function (m) {
    return [m, ofArray([function (_arg1) {
      pushState(toUrl(m.Value));
    }])];
  }(action.Case === "Decrement" ? new Model(model.Value - 1) : action.Case === "Reset" ? new Model(0) : new Model(model.Value + 1));
}
function navigationUpdate(model, urlValue) {
  return [new Model(urlValue), new List$1()];
}
function voidLinkAction() {
  return Attributes.property("href", "javascript:void(0)");
}
function simpleButton(txt, action) {
  return Tags.div(ofArray([Attributes.classy("column is-narrow is-narrow-mobile")]))(ofArray([Tags.a(ofArray([Attributes.classy("button"), voidLinkAction(), Events.onMouseClick(function (_arg1) {
    return action;
  })]))(ofArray([Tags.text(txt)]))]));
}
function view(model) {
  return Tags.div(ofArray([Attributes.classy("columns is-vcentered is-flex-mobile")]))(ofArray([Tags.div(ofArray([Attributes.classy("column")]))(new List$1()), Tags.div(ofArray([Attributes.classy("column is-narrow is-narrow-mobile"), new Types$1.Attribute("Style", [ofArray([["width", "170px"]])])]))(ofArray([Tags.text(fsFormat("Counter value: %i")(function (x) {
    return x;
  })(model.Value))])), simpleButton("+1", new Actions("Increment", [])), simpleButton("-1", new Actions("Decrement", [])), simpleButton("Reset", new Actions("Reset", [])), Tags.div(ofArray([Attributes.classy("column")]))(new List$1())]));
}
AppApi.start(function () {
  var urlUpdate = function urlUpdate(model) {
    return function (urlValue) {
      return navigationUpdate(model, urlValue);
    };
  };

  return function (app) {
    return withNavigation(function (location) {
...
exports.voidLinkAction = voidLinkAction;

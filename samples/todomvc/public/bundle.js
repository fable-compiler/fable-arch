...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(2), __webpack_require__(3), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore, _FableArch, _FableArch2, _FableArch3) {
	    ...
	    exports.initModel = exports.initList = exports.Storage = exports.TodoAction = exports.Model = exports.Item = exports.Filter = undefined;
	    ...
	    _fableCore.Util.setInterfaces(Filter.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Todomvc.Filter");
	    ...
	    _fableCore.Util.setInterfaces(Item.prototype, ["FSharpRecord", "System.IEquatable", "System.IComparable"], "Todomvc.Item");
	
	    var Model = exports.Model = function () {
	        function Model(items, input, filter) {
	    ...
	    _fableCore.Util.setInterfaces(Model.prototype, ["FSharpRecord", "System.IEquatable", "System.IComparable"], "Todomvc.Model");
	    ...
	    _fableCore.Util.setInterfaces(TodoAction.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Todomvc.TodoAction");
	
	    function update(model, msg) {
	        var updateItems = function updateItems(model_1) {
	            return function (f) {
	                var items_ = f(model_1.Items);
	                return new Model(items_, model_1.Input, model_1.Filter);
	            };
	        };
	        ...
	        var model_ = msg.Case === "AddItem" ? function () {
	            ...
	            return updateItems(function () {
	                var Input = "";
	                return new Model(model.Items, Input, model.Filter);
	            }())(function (items) {
	                return _fableCore.List.append(items, _fableCore.List.ofArray([function () {
	                    var Id = maxId + 1;
	                    return new Item(msg.Fields[0], false, Id, false);
	                }()]));
	            });
	        }() : msg.Case === "ChangeInput" ? new Model(model.Items, msg.Fields[0], model.Filter) : msg.Case === "MarkAsDone" ? updateItem(function () {
	            var Done = true;
	            ...
	            return new Item(msg.Fields[0].Name, Done, msg.Fields[0].Id, msg.Fields[0].IsEditing);
	        }())(model) : msg.Case === "SetActiveFilter" ? new Model(model.Items, model.Input, msg.Fields[0]) : msg.Case === "ClearCompleted" ? updateItems(model)(function () {
	        ...
	        var jsCall = msg.Case === "EditItem" ? _FableArch.AppApi.toActionList(function (x) {
	    ...
	    function filter(activeFilter, f) {
	        ...
	        return function () {
	            ...
	            var tagName = "a";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["href", "#/" + patternInput[1]]]), new _FableArch2.Types.Attribute("Attribute", [["class", linkClass]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("Text", [patternInput[0]])]))]));
	    }
	    ...
	    function filters(model) {
	        return function () {
	            var tagName = "ul";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "filters"]])])], children]);
	            };
	    ...
	    function todoFooter(model) {
	        ...
	        return function () {
	            var tagName = "footer";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "footer"]]), new _FableArch2.Types.Attribute("Style", [_fableCore.List.ofArray([["display", "block"]])])])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "span";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "todo-count"]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "strong";
	            return function (children) {
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("Text", [activeCount])])), new _FableArch2.Types.DomNode("Text", [" items left"])])), filters(model), function () {
	            var tagName = "button";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "clear-completed"]]), new _FableArch2.Types.Attribute("Style", [_fableCore.List.ofArray([["display", clearVisibility]])]), function () {
	                    var h = function h(e) {
	                        e.stopPropagation();
	                        e.preventDefault();
	                        return function (_arg1) {
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("Text", ["Clear completed"])]))]));
	    }
	
	    function onEnter(succ, nop) {
	        return new _FableArch2.Types.Attribute("EventHandler", [["onkeyup", function (x) {
	            return x.keyCode === 13 ? function () {
	                var value = _fableCore.Util.toString(x.target.value);
	    ...
	    function todoHeader(model) {
	        return function () {
	            var tagName = "header";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "header"]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "h1";
	            return function (children) {
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("Text", ["todos"])])), new _FableArch2.Types.DomNode("VoidElement", [["input", _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "new-todo"]]), new _FableArch2.Types.Attribute("Attribute", [["id", "new-todo"]]), new _FableArch2.Types.Attribute("Property", [["placeholder", "What needs to be done?"]]), onEnter(function (arg0) {
	            return new TodoAction("AddItem", [arg0]);
	        }, new TodoAction("NoOp", []))])]])]));
	    }
	    ...
	    function listItem(item) {
	        ...
	        return function () {
	            var tagName = "li";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", (item.Done ? "completed " : " ") + editClass]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "view"]]), function () {
	                    var h = function h(e) {
	                        e.stopPropagation();
	                        e.preventDefault();
	                        return function (x) {
	                    ...
	                    return new _FableArch2.Types.Attribute("EventHandler", [["ondblclick", h]]);
	                }()])], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("VoidElement", [["input", _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Property", [["className", "toggle"]]), new _FableArch2.Types.Attribute("Property", [["type", "checkbox"]]), new _FableArch2.Types.Attribute("Property", [["checked", itemChecked]]), function () {
	            var h = function h(e) {
	                e.stopPropagation();
	                e.preventDefault();
	                return function (e) {
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("Text", [item.Name])])), function () {
	            var tagName = "button";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "destroy"]]), function () {
	                    var h = function h(e) {
	                        e.stopPropagation();
	                        e.preventDefault();
	                        return function (e) {
	        ...
	        }()(new _fableCore.List())])), new _FableArch2.Types.DomNode("VoidElement", [["input", _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "edit"]]), new _FableArch2.Types.Attribute("Attribute", [["value", item.Name]]), new _FableArch2.Types.Attribute("Property", [["id", "item-" + String(item.Id)]]), new _FableArch2.Types.Attribute("EventHandler", [["onblur", function (e) {
	    ...
	    function itemList(items, activeFilter) {
	        ...
	        return function () {
	            var tagName = "ul";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "todo-list"]])])], children]);
	            };
	        }()(function (list) {
	    ...
	    function todoMain(model) {
	        ...
	        return function () {
	            var tagName = "section";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "main"]]), new _FableArch2.Types.Attribute("Style", [_fableCore.List.ofArray([["style", "block"]])])])], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("VoidElement", [["input", _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Property", [["id", "toggle-all"]]), new _FableArch2.Types.Attribute("Attribute", [["class", "toggle-all"]]), new _FableArch2.Types.Attribute("Property", [["type", "checkbox"]]), new _FableArch2.Types.Attribute("Property", [["checked", !allChecked ? "true" : ""]]), function () {
	            var h = function h(e) {
	                e.stopPropagation();
	                e.preventDefault();
	                return function (e) {
	            ...
	            var tagName = "label";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["for", "toggle-all"]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch2.Types.DomNode("Text", ["Mark all as complete"])])), itemList(model.Items, model.Filter)]));
	    }
	    ...
	    function view(model) {
	        return function () {
	            var tagName = "section";
	            return function (children) {
	                return new _FableArch2.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch2.Types.Attribute("Attribute", [["class", "todoapp"]])])], children]);
	            };
	    ...
	    var initModel = exports.initModel = function () {
	        ...
	        return new Model(initList, "", Filter_1);
	    }();
	
	    _FableArch.AppApi.start(_FableArch.AppApi.withStartNodeSelector("#todoapp", _FableArch.AppApi.withSubscriber(function (m) {
	        Storage.save(Array.from(m.CurrentState.Items));
	    }, _FableArch.AppApi.createApp(initModel, function (model) {
	        return view(model);
	    }, function (model) {
	        return function (msg) {

	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore, _FableHelpers) {
	    ...
	    function update(model, msg) {
	        ...
	        var model_ = msg.Case === "AddItem" ? function () {
	            ...
	            var v = msg.Fields[0];
	            return new Model(model.Items, v, model.Filter);
	            ...
	            var f = msg.Fields[0];
	            return new Model(model.Items, model.Input, f);
	    ...
	    _FableHelpers.App.start((0, _FableHelpers.renderer)(), _FableHelpers.App.withStartNodeSelector("#todoapp", _FableHelpers.App.withSubscriber("modellogger", _fableCore.String.fsFormat("%A")(function (x) {
	        console.log(x);

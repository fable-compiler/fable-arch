...
function view(model) {
  return Tags.div(ofArray([Attributes.classy("columns is-vcentered is-flex-mobile")]))(ofArray([Tags.div(ofArray([Attributes.classy("column")]))(new List$1()), Tags.div(ofArray([Attributes.classy("column is-narrow is-narrow-mobile"), new Types.Attribute("Style", [ofArray([["width", "170px"]])])]))(ofArray([Tags.text(fsFormat("Counter value: %i")(function (x) {
    return x;
  })(model.Value))])), simpleButton("+1", new Actions("Add", [])), simpleButton("-1", new Actions("Sub", [])), simpleButton("Reset", new Actions("Reset", [])), Tags.div(ofArray([Attributes.classy("column")]))(new List$1())]));
}
AppApi.start(AppApi.withStartNodeSelector("#sample", AppApi.createSimpleApp(Model.Initial, function (model) {
  return view(model);
}, function (model) {

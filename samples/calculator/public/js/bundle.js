...
function inputString(_arg1) {
  var activePatternResult111 = _Operation___(_arg1);

  if (activePatternResult111 != null) {
    return opString(activePatternResult111);
...
function solve(_arg1) {
  ...
  if (_arg1.Fields[0].tail != null) {
    if (_arg1.Fields[0].head.Case === "Const") {
      if (_arg1.Fields[0].tail.tail != null) {
        var activePatternResult114 = _Operation___(_arg1.Fields[0].tail.head);

        if (activePatternResult114 != null) {
          if (_arg1.Fields[0].tail.tail.tail != null) {
            if (_arg1.Fields[0].tail.tail.head.Case === "Const") {
              if (_arg1.Fields[0].tail.tail.tail.tail == null) {
                $var1 = [0, activePatternResult114, _arg1.Fields[0].head.Fields[0], _arg1.Fields[0].tail.tail.head.Fields[0]];
              } else {
                $var1 = [1];
              }
            } else {
  ...
  switch ($var1[0]) {
    case 0:
      ...
      } else if ($var1[1].Case === "Minus") {
        return $var1[2] - $var1[3];
      } else if ($var1[1].Case === "Times") {
        return $var1[2] * $var1[3];
      } else if ($var1[1].Case === "Div") {
        return ~~($var1[2] / $var1[3]);
      } else {
    ...
    case 1:
      throw new Error("/Users/maxime/Workspace/fable-arch/docs/samples/calculator/sample.fsx", 62, 11);
  }
}
function update(_arg2, _arg1) {
  if (_arg1.Fields[0].Equals(new Input("Clear", []))) {
    return new Model("InputStack", [new List$1()]);
  } else {
    var $var2 = void 0;
    ...
    if (_arg2.Fields[0].tail != null) {
      if (_arg2.Fields[0].head.Case === "Const") {
        if (_arg2.Fields[0].tail.tail != null) {
          var activePatternResult121 = _Operation___(_arg2.Fields[0].tail.head);

          if (activePatternResult121 != null) {
            if (_arg2.Fields[0].tail.tail.tail == null) {
              $var2 = [2, activePatternResult121, _arg2.Fields[0].head.Fields[0]];
            } else {
              $var2 = [3];
            }
          } else {
          ...
          $var2 = [1, _arg2.Fields[0].head.Fields[0]];
        }
      } else {
        $var2 = [3];
      }
    ...
    switch ($var2[0]) {
      case 0:
        var activePatternResult116 = _Operation___(_arg1.Fields[0]);

        if (activePatternResult116 != null) {
          return new Model("InputStack", [new List$1()]);
        } else if (_arg1.Fields[0].Case === "Equals") {
          return new Model("InputStack", [new List$1()]);
        } else {
          return new Model("InputStack", [ofArray([_arg1.Fields[0]])]);
        }

      case 1:
        if (_arg1.Fields[0].Case === "Const") {
          return new Model("InputStack", [ofArray([new Input("Const", [concatInts($var2[1], _arg1.Fields[0].Fields[0])])])]);
        } else {
          var activePatternResult117 = _Operation___(_arg1.Fields[0]);

          if (activePatternResult117 != null) {
            return new Model("InputStack", [ofArray([new Input("Const", [$var2[1]]), activePatternResult117])]);
          } else {
            return new Model("InputStack", [_arg2.Fields[0]]);
          }
        }

      case 2:
        if (_arg1.Fields[0].Case === "Const") {
          return new Model("InputStack", [ofArray([new Input("Const", [$var2[2]]), $var2[1], new Input("Const", [_arg1.Fields[0].Fields[0]])])]);
        } else {
          var activePatternResult118 = _Operation___(_arg1.Fields[0]);

          if (activePatternResult118 != null) {
            return new Model("InputStack", [ofArray([new Input("Const", [$var2[2]]), activePatternResult118])]);
          } else {
            return new Model("InputStack", [_arg2.Fields[0]]);
          }
        }
      ...
      case 3:
        ...
        if (_arg2.Fields[0].tail != null) {
          if (_arg2.Fields[0].head.Case === "Const") {
            if (_arg2.Fields[0].tail.tail != null) {
              var activePatternResult120 = _Operation___(_arg2.Fields[0].tail.head);

              if (activePatternResult120 != null) {
                if (_arg2.Fields[0].tail.tail.tail != null) {
                  if (_arg2.Fields[0].tail.tail.head.Case === "Const") {
                    if (_arg2.Fields[0].tail.tail.tail.tail == null) {
                      $var3 = [0, activePatternResult120, _arg2.Fields[0].head.Fields[0], _arg2.Fields[0].tail.tail.head.Fields[0]];
                    } else {
                      $var3 = [1];
                    }
                  } else {
        ...
        switch ($var3[0]) {
          case 0:
            if (_arg1.Fields[0].Case === "Const") {
              return new Model("InputStack", [ofArray([new Input("Const", [$var3[2]]), $var3[1], new Input("Const", [concatInts($var3[3], _arg1.Fields[0].Fields[0])])])]);
            } else if (_arg1.Fields[0].Case === "Equals") {
              return new Model("InputStack", [ofArray([new Input("Const", [solve(new Model("InputStack", [_arg2.Fields[0]]))])])]);
            } else {
              var activePatternResult119 = _Operation___(_arg1.Fields[0]);

              if (activePatternResult119 != null) {
                var result = solve(new Model("InputStack", [_arg2.Fields[0]]));
                return new Model("InputStack", [ofArray([new Input("Const", [result]), activePatternResult119])]);
              } else {
                return new Model("InputStack", [_arg2.Fields[0]]);
              }
            }
...
function view(model) {
  var digit = function digit(n) {
    return Tags.div(ofArray([digitStyle(), Events.onMouseClick(function (_arg1) {
      return new Actions("PushInput", [new Input("Const", [n])]);
  ...
  var opBtn = function opBtn(input) {
    ...
    var activePatternResult128 = _Operation___(input);

    if (activePatternResult128 != null) {
      content = opString(activePatternResult128);
    ...
    return Tags.div(ofArray([opButtonStyle(), Events.onMouseClick(function (_arg2) {
      return new Actions("PushInput", [input]);
...
exports.$7C$Operation$7C$_$7C$ = _Operation___;
exports.concatInts = concatInts;
exports.opString = opString;
exports.inputString = inputString;
exports.modelString = modelString;
exports.solve = solve;
exports.update = update;
exports.digitStyle = digitStyle;
exports.opButtonStyle = opButtonStyle;
exports.view = view;

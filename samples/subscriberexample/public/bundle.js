...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore, _FableHelpers) {
	    ...
	    function view(model) {
	        ...
	        }()(_fableCore.List.ofArray([new _FableHelpers.Html.Types.DomNode("Text", [_fableCore.String.fsFormat("Hello %s")(function (x) {
	            return x;
	        })(model)])]))]));
	    }
	
	    _FableHelpers.App.start((0, _FableHelpers.renderer)(), _FableHelpers.App.withSubscriber("Logger", function (x) {
	        console.log("Event received: ", x);
	    }, _FableHelpers.App.withStartNodeSelector("#hello", _FableHelpers.App.createSimpleApp("", function (model) {
	        return view(model);
	    }, function (model) {
	        return function (msg) {

...
module Svg =
    ...
    let polygon x = svgElem "polygon" x
    let path x = svgElem "path" x
    let ellipse x = svgElem "ellipse" x
    let defs x = svgElem "defs" x
    let linearGradient x = svgElem "linearGradient" x
    let radialGradient x = svgElem "radialGradient" x
    let stop x = svgElem"stop" x

    let d x = attribute "d" x
    let points x = attribute "points" x
    ...
    let rx x = attribute "rx" x
    let ry x = attribute "ry" x
